...
export const Header = () => {
  ...
  return (
    <header>
      <nav className="bg-white border-b2 border-gray-200 px-2 sm:px-4 py-2 dark:border-b-1 dark:bg-gray-900">
        <div className=" flex flex-wrap  justify-between items-center mx-auto">
          <Link to="/" className="flex items-center">
            <img src={Logo} className="h-10  mr-2 sm:h-9" alt="Cinemate Logo" />
          ...
          <div className={`${hidden ? "hidden" : ""} justify-between  w-full items-center  md:flex md:w-auto md:order-1`} id="navbar-search">
